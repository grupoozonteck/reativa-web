...
const config: Config = {
    ...
    theme: {
        extend: {
            ...
            boxShadow: {
                'glow-primary':
                    '0 0 20px 0 hsl(83 98% 64% / 0.25), 0 0 40px 0 hsl(83 98% 64% / 0.08)',
            ...
            keyframes: {
                ...
                'pulse-glow': {
                    '0%, 100%': {
                        boxShadow: '0 0 12px 0 hsl(83 98% 64% / 0.2)',
                    },
            ...
            animation: {
                'fade-in':
                    'fade-in 0.45s cubic-bezier(0.22, 1, 0.36, 1) forwards',
                'scale-in':
                ...
                'bounce-in':
                    'bounce-in 0.5s cubic-bezier(0.22, 1, 0.36, 1) forwards',
                'rise-up':
                    'rise-up 0.7s cubic-bezier(0.22, 1, 0.36, 1) forwards',
                'aurora-shift':
