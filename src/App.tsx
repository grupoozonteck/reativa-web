            ...
            <BrowserRouter>
                <Routes>
                    ...
                    <Route element={<ProtectedApp />}>
                        ...
                        />
                        <Route
                            path="/reengagements/situation"
                            element={<CustomerSituation />}
                        />
                        <Route
                    ...
                    <Route
                        path="/reengagements/generate"
                        element={
                            <Navigate to="/reengagements/generate" replace />
                        }
                    />
                    <Route
                        path="/my-attendances"
                        element={<Navigate to="/my-attendances" replace />}
                    />
                    <Route
                        path="/team-attendances"
                    ...
                    <Route
                        path="/supervisor/ranking"
                        element={<Navigate to="/supervisor/ranking" replace />}
                    />
                    <Route
                        path="/attendants"
                        element={<Navigate to="/attendants" replace />}
                    />
                    <Route
                        path="/attendants/:id"
                        element={<Navigate to="/attendants" replace />}
