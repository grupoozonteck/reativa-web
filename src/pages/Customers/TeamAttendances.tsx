...
export default function TeamAttendances() {
    ...
    const { data, isLoading, isFetching, refetch } = useQuery({
        ...
        queryFn: () =>
            customerService.getTeamReengagements({
                page,
            ...
            <div className="flex items-center justify-between animate-fade-in flex-col sm:flex-row gap-4">
                <div>
                    ...
                    <p className="text-on-surface-variant text-sm mt-0.5 hidden sm:block ml-0.5">
                        Reativacoes conduzidas pelos membros da sua equipe no
                        periodo selecionado
                    </p>
                </div>
                <Button
            ...
            <div className="solid-card p-4 animate-fade-in">
                ...
                >
                    <div className="grid grid-cols-1 gap-3 md:grid-cols-[minmax(0,1.5fr)_160px_160px_220px]">
                        <Field>
                            <FieldLabel htmlFor="team-attendances-search">
                                Buscar
                            </FieldLabel>
                        ...
                        <Field>
                            <FieldLabel htmlFor="team-attendances-start-date">
                                Data inicial
                            </FieldLabel>
                            <Input
                        ...
                        <Field>
                            <FieldLabel htmlFor="team-attendances-end-date">
                                Data final
                            </FieldLabel>
                            <Input
                        ...
                        <Field>
                            <FieldLabel htmlFor="team-attendances-status">
                                Status
                            </FieldLabel>
                            <Select
                            ...
                            <Table>
                                <TableHeader className="sticky bg-surface-highest top-0 z-10">
                                    <TableRow className="border-none hover:bg-transparent bg-surface-highest/90 backdrop-blur-sm">
                                        ...
                                        <TableHead className="uppercase tracking-wider font-semibold text-on-surface-variant px-3">
                                            Cliente
                                        </TableHead>
                                        <TableHead className="uppercase tracking-wider font-semibold text-on-surface-variant w-[14%] px-3">
                                            Lider
                                        </TableHead>
                                        <TableHead className="uppercase tracking-wider font-semibold text-on-surface-variant w-[14%] px-3">
                                            Atendente
                                        </TableHead>
                                        <TableHead className="uppercase tracking-wider font-semibold text-on-surface-variant text-center w-[16%] px-3">
                                            Status
                                        </TableHead>
                                        <TableHead className="uppercase tracking-wider font-semibold text-on-surface-variant text-center w-[10%] px-3">
                                            Inicio
                                        </TableHead>
                                        <TableHead className="uppercase tracking-wider font-semibold text-on-surface-variant text-center w-[8%] px-3">
                                            Ações
                                        </TableHead>
                                    </TableRow>
                                </TableHeader>
