...
export default function MyAttendances() {
    ...
    const resolvedEndDate = appliedStartDate && !appliedEndDate ? today : (appliedEndDate || undefined);

    const { data, isLoading, isFetching, refetch } = useQuery({
        queryKey: ['personal-reengagements', page, appliedSearch, appliedStartDate, resolvedEndDate, appliedStatus],
        queryFn: () => customerService.getPersonalReengagements({
            page,
            search: appliedSearch || undefined,
            start_date: appliedStartDate || undefined,
            end_date: resolvedEndDate,
            status: appliedStatus ? Number(appliedStatus) : undefined,
        }),
    ...
    const hasActiveFilters = appliedSearch !== '' || appliedStartDate !== currentMonthStart || appliedEndDate !== today || appliedStatus !== '';
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                        ...
                        <div className="flex flex-col md:flex-row gap-2 w-full md:w-auto">
                            ...
                            <Button
                                ...
                                disabled={!search && isDefaultPeriod && !selectedStatus && !hasActiveFilters}
                            >
                                <X className="w-3.5 h-3.5" />
                                Limpar filtros
                            </Button>
