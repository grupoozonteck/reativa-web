...
export default function ClienteDetalhes() {
    ...
    const handleAccessStore = async () => {
        ...
        try {
            ...
            const accessUrl = token
                ? buildStoreAccessUrl(token, res?.data?.url)
                : null;
    ...
    if (isLoading) {
        return <PageLoadingState message="Carregando detalhes do cliente..." />;
    }
    ...
    const personalAddress =
        user.personal_address ?? user.personalAddress ?? null;
    const whatsapp =
    ...
    const orders = (user.personal_orders ?? user.personalOrders ?? [])
        .slice()
        .sort(
            (a, b) =>
    ...
    const reengStatus = reengagement
        ? reengagementStatusMap[reengagement.status]
        : null;
                    ...
                    <CardContent className="p-5 sm:p-6">
                        <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                            ...
                            {personalData?.avatar ? (
                                ...
                                <div
                                    className={cn(
                                        'w-16 h-16 rounded-2xl flex items-center justify-center text-white text-2xl font-bold shrink-0',
                                        avatarColor,
                                    )}
                                >
                                    {initials}
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex flex-wrap items-center gap-2 mb-0.5">
                                    <h1 className="font-display text-xl font-black text-on-surface">
                                        {user.name}
                                    </h1>
                                    {reengStatus && (
                                        <Badge
                                ...
                                {reengagement && (
                                    <div className="flex flex-wrap gap-x-5 gap-y-1">
                                        <div>
                                            <span className="text-xs uppercase tracking-wider text-on-surface">
                                                Atendimento{' '}
                                            </span>
                            ...
                            <div className="lg:col-span-2 space-y-4">
                                ...
                                <Card>
                                    ...
                                    <CardContent className="p-0">
                                        {orders.length === 0 ? (
                                            <p className="text-sm text-on-surface-variant/50 px-5 pb-5">
                                                    ...
                                                    {orders.map((order) => {
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                <TableCell className="text-right font-semibold text-secondary text-sm">
                                                                    {formatCurrency(
                                                                        order.value,
                                                                    )}
                                                                </TableCell>
