                ...
                {leader && (
                    <div className="rounded-2xl border border-white/5 bg-surface-highest/45 px-3 py-3">
                        <div className="flex min-w-0 items-start gap-2.5">
                            ...
                            <div className="min-w-0">
                                <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-on-surface-variant">Lider</p>
                ...
                {recruiter && (
                    <div className="rounded-2xl border border-white/5 bg-surface-highest/45 px-3 py-3">
                        <div className="flex min-w-0 items-start gap-2.5">
                            ...
                            <div className="min-w-0">
                                <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-on-surface-variant">Atendente</p>
                                <p className="mt-1 truncate text-sm font-medium text-on-surface">{recruiter.name}</p>
                                <p className="truncate text-xs text-on-surface-variant">@{recruiter.login}</p>
                            </div>
                        </div>
                    </div>
                )}
