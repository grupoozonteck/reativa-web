        ...
        <div className="solid-card overflow-hidden rounded-2xl">
            ...
            >
                {visible.map((seller, index) => {
                    ...
                    const avatarUrl =
                        seller.user.personal_data?.avatar ?? undefined;
                        ...
                        >
                            <div className="grid gap-4 lg:hidden">
                                <div className="flex items-center gap-3">
                                    <span
                                        className={cn(
                                            'text-lg font-black tabular-nums w-8 shrink-0',
                                            isTop3
                                                ? medal.text
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <div className="flex items-center gap-2">
                                            ...
                                            {index === 0 && (
                                                <Flame className="w-3.5 h-3.5 text-amber-400 fill-amber-400/50 shrink-0" />
                                            )}
                                            {index === 1 && (
                            ...
                            <div className="hidden lg:grid lg:grid-cols-[56px_minmax(220px,1fr)_86px_64px_92px_120px] lg:items-center">
                                ...
                                <span className="text-sm font-bold tabular-nums text-foreground ml-4">
                                    {seller.sales}
                                </span>
                                ...
                                <AnimatedNumber
                                    ...
                                    duration={1.2}
                                    className={cn(
                                        'text-right text-sm font-black tabular-nums block',
...
function MobileMetric({
    ...
    return (
        <div className="rounded-xl border border-border/50 bg-muted/20 px-3 py-2">
            ...
            <div
                className={cn(
                    'pt-1 text-sm font-bold tabular-nums text-foreground',
                    valueClassName,
                )}
            >
                {value}
